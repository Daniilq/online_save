...
#define SERVO_PIN 12
#define ZERO_POS 93				//среднее положение сервы
#define MAX_SERVO_ANGLE 35		//максимальный yгол поворот(по умолчанию 40)

#define MIN_MOTOR_SPEED 100		// минимальная скорость 
...
int16_t sensor_correction[TOTAL_SENSORS]={-3, -2, 0, -1, -2, -2, 0, -2, -2, -20, -1};  // массив со значениями коррекции датчиков, для выравнивания их значений между собой
